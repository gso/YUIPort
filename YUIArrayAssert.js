...
YUIArrayAssert = {
    ...
    contains : function (needle, haystack, 
        ...
        // [Not required outside of YUI framework.  #yp ]
        ...
        if (this._indexOf(haystack, needle) == -1){
            ...
            YUIAssert.fail(YUIAssert._formatMessage(message, "Value " + needle + " (" + (typeof needle) + ") not found in array [" + haystack + "]."));
        }
    },
    ...
    containsItems : function (needles, haystack, 
        ...
        for (var i=0; i < needles.length; i++){
            ...
            // [Namespace.  #yp ]
                ...
                YUIAssert.fail(YUIAssert._formatMessage(message, "Value " + needles[i] + " (" + (typeof needles[i]) + ") not found in array [" + haystack + "]."));
            }
        }
    },
    ...
    containsMatch : function (matcher, haystack, 
        ...
        if (!this._some(haystack, matcher)){
            ...
            YUIAssert.fail(YUIAssert._formatMessage(message, "No match found in array [" + haystack + "]."));
        }
    },
    ...
    doesNotContain : function (needle, haystack, 
        ...
        if (this._indexOf(haystack, needle) > -1){
            ...
            YUIAssert.fail(YUIAssert._formatMessage(message, "Value found in array [" + haystack + "]."));
        }
    },
    ...
    indexOf : function (needle, haystack, index, message) {
        ...
        for (var i=0; i < haystack.length; i++){
            if (haystack[i] === needle){
                if (index != i){
                    ...
                    YUIAssert.fail(YUIAssert._formatMessage(message, "Value exists at index " + i + " but should be at index " + index + "."));                    
                }
                return;
            }
        }
        ...
        YUIAssert.fail(YUIAssert._formatMessage(message, "Value doesn't exist in array [" + haystack + "]."));
    },
    ...
    itemsAreEqual : function (expected, actual, 
        ...
        if (typeof expected != "object" || typeof actual != "object"){
            ...
            YUIAssert.fail(YUIAssert._formatMessage(message, "Value should be an array."));
        }
        ...
        if (expected.length != actual.length){
            ...
            YUIAssert.fail(YUIAssert._formatMessage(message, "Array should have a length of " + expected.length + " but has a length of " + actual.length + "."));
        }
        ...
        for (var i=0; i < expected.length; i++){
            if (expected[i] != actual[i]){
                ...
                throw new YUIComparisonFailure(YUIAssert._formatMessage(message, "Values in position " + i + " are not equal."), expected[i], actual[i]);
            }
        }
    },
    ...
    itemsAreEquivalent : function (expected, actual, 
        ...
        for (var i=0; i < expected.length; i++){
            if (!comparator(expected[i], actual[i])){
                ...
                throw new YUIComparisonFailure(YUIAssert._formatMessage(message, "Values in position " + i + " are not equivalent."), expected[i], actual[i]);
            }
        }
    },
    ...
    isEmpty : function (actual, message) {        
        ...
        if (actual.length > 0){
            ...
            YUIAssert.fail(YUIAssert._formatMessage(message, "Array should be empty."));
        }
    },    
    ...
    isNotEmpty : function (actual, message) {        
        ...
        if (actual.length === 0){
            ...
            YUIAssert.fail(YUIAssert._formatMessage(message, "Array should not be empty."));
        }
    },    
    ...
    itemsAreSame : function (expected, actual, 
        ...
        for (var i=0; i < expected.length; i++){
            if (expected[i] !== actual[i]){
                ...
                throw new YUIComparisonFailure(YUIAssert._formatMessage(message, "Values in position " + i + " are not the same."), expected[i], actual[i]);
            }
        }
    },
    ...
    lastIndexOf : function (needle, haystack, index, message) {
        ...
        YUIAssert.fail(YUIAssert._formatMessage(message, "Value doesn't exist in array."));        
    }
